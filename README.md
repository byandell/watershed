...
|----------|-------------|
| `hexmapApp()` | Launch the interactive Hexagonal Watershed Projection Shiny application |
| `hexmapInput()`, `hexmapOutput()`, `hexmapServer()` | Shiny module UI and server components for hexmap composition |
