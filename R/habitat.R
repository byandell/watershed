...
utils::globalVariables(c(".data", "isle_royale_datasets"))
...
#' @param features Alias for `habitat_sf`.
#' @param landmarks Alias for `landmarks_sf`.
#'
...
#' @rdname habitat
#'
#' @importFrom ggplot2 autoplot ggplot geom_sf theme_minimal ggtitle labs scale_fill_viridis_c aes geom_sf_text
